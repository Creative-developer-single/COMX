...
// ==============================================================
#ifndef __run_fmul_32ns_32ncud__HH__
#define __run_fmul_32ns_32ncud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(run_fmul_32ns_32ncud) {
    ...
    SC_CTOR(run_fmul_32ns_32ncud):  ACMP_fmul_comb_U ("ACMP_fmul_comb_U") {
