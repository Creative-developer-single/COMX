...
// ==============================================================
#ifndef __run_fcmp_32ns_32ndEe__HH__
#define __run_fcmp_32ns_32ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(run_fcmp_32ns_32ndEe) {
    ...
    SC_CTOR(run_fcmp_32ns_32ndEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
