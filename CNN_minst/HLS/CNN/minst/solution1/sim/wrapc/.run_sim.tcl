...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "run.autotvin.dat"
	set constFileTvOut       "run.autotvout.dat"
	set constFileHdlTvIn     "run.autohdltvin.dat"
	set constFileHdlTvOut    "run.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
