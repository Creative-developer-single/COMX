# ==============================================================
# File generated on Thu Feb 22 01:26:46 +0800 2024
...
if {[file isfile run.autotvin.dat]} {
	file delete -force run.autotvin.dat
}

if {[file isfile run.autotvout.dat]} {
	file delete -force run.autotvout.dat
}
