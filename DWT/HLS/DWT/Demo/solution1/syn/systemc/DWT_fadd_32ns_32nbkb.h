...
// ==============================================================
#ifndef __DWT_fadd_32ns_32nbkb__HH__
#define __DWT_fadd_32ns_32nbkb__HH__
#include "ACMP_fadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DWT_fadd_32ns_32nbkb) {
    ...
    SC_CTOR(DWT_fadd_32ns_32nbkb):  ACMP_fadd_U ("ACMP_fadd_U") {
        ACMP_fadd_U.clk(clk);
