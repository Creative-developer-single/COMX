...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2018.3/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2018.3/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2018.3/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2018.3/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vivado/2018.3/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DWT.autotvin.dat"
	set constFileTvOut       "DWT.autotvout.dat"
	set constFileHdlTvIn     "DWT.autohdltvin.dat"
	set constFileHdlTvOut    "DWT.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
