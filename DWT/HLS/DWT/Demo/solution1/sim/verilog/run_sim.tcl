# ==============================================================
# File generated on Sun Feb 18 10:31:15 +0800 2024
...
if {[file isfile DWT.autotvin.dat]} {
	file delete -force DWT.autotvin.dat
}

if {[file isfile DWT.autotvout.dat]} {
	file delete -force DWT.autotvout.dat
}
