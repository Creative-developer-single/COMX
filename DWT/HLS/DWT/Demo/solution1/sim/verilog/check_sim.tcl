...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.DWT.autotvin_data.dat"
         "c.DWT.autotvin_read_valid.dat"
         "c.DWT.autotvout_data_out.dat"
         "c.DWT.autotvout_read_ready.dat"
         "c.DWT.autotvout_read_over.dat"
         "c.DWT.autotvout_write_valid.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.DWT.autotvout_data_out.dat"
         "rtl.DWT.autotvout_read_ready.dat"
         "rtl.DWT.autotvout_read_over.dat"
         "rtl.DWT.autotvout_write_valid.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
