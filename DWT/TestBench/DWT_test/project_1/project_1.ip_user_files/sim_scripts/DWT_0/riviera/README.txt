...
#
# Generated by export_simulation on Sun Feb 18 10:41:59 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './DWT_0.sh' script.
...
./DWT_0.sh -noclean_files

For more information on the script, please type './DWT_0.sh -help'.
