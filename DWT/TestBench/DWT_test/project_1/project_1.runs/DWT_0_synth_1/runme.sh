...
HD_PWD='E:/FPGA/Xilinx/tests/DWT_test/project_1/project_1.runs/DWT_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DWT_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DWT_0.tcl
